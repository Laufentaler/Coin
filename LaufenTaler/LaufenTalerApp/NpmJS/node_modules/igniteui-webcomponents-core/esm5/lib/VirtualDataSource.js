...
var VirtualDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function VirtualDataSource() {
        ...
        _this.ct = null;
        _this.cu = null;
        _this.db = new LRUCache$2(Base.$, IDataSourcePage_$type, 0, 200);
        _this.di = new Dictionary$2(Base.$, Array_$type, 0);
        _this.dj = new Dictionary$2(Number_$type, Number_$type, 0);
        _this.dd = false;
        _this.cr = null;
        _this.cw = null;
        _this.da = new SectionMap();
        _this.cs = null;
        _this.dt = -1;
        _this.dl = -1;
        _this.dv = -1;
        ...
        _this.dq = -1;
        _this.ds = -1;
        _this.dh = new Dictionary$2(String_$type, Boolean_$type, 0);
        _this._concurrencyTag = null;
        _this.batchStarted = null;
        _this.batchCompleted = null;
        _this.c8 = new PagePredictionEngine();
        _this.c8.e = _this;
        _this.c8.ag = _this.actualPageSize;
        _this.c8.f = _this.da;
        _this.executionContext = new DataSourceExecutionContext();
        _this.c8.b = _this.executionContext;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "c4", {
        get: function () {
            return this.c3;
        },
        set: function (a) {
    ...
    VirtualDataSource.prototype.d4 = function (a) {
    ...
    VirtualDataSource.prototype.el = function (a, b, c) {
        var _this = this;
        var d = this.executionContext;
        if (d != null) {
            d.execute(function () { return _this.er(a, b, c); });
        }
        else {
            this.er(a, b, c);
        }
    ...
    VirtualDataSource.prototype.eq = function () {
        ...
        for (var e = 0; e < this.cr.length; e++) {
            var f = new SectionData();
            var g = b;
            var h = this.cr[e].endIndex - this.cr[e].startIndex;
            f.af = a;
            f.ae = e;
        ...
        var t = 0;
        for (var u = 0; u < this.da.t.count; u++) {
            var v = this.da.t._inner[u];
    ...
    VirtualDataSource.prototype.ej = function (a, b) {
        if (b) {
            this.ct = new Array(this.groupDescriptions.k.count);
            for (var c = 0; c < this.ct.length; c++) {
                this.ct[c] = a;
            }
        }
    ...
    VirtualDataSource.prototype.ei = function (a) {
    };
    ...
    VirtualDataSource.prototype.d8 = function (a) {
        if (a >= this.actualCount - this.d1) {
            ...
            b.rowType = 4;
            b.level = 0;
            var c = a - (this.actualCount - this.d1);
            var d = SectionData.r(this.cw);
    ...
    VirtualDataSource.prototype.cx = function (a) {
        if (this.an && this.da.q) {
            var b = false;
            var c = this.c9(a);
            if (c == null) {
    ...
    VirtualDataSource.prototype.c9 = function (a) {
        return this.da.e(a);
    };
    ...
    VirtualDataSource.prototype.d9 = function (a, b) {
        var c = this.d8(a);
    ...
    VirtualDataSource.prototype.removeCandidate = function (a) {
        if (this.di.containsKey(a)) {
            for (var b = 0; b < this.di.item(a).length; b++) {
                var c = this.di.item(a)[b];
                this.em(c);
            }
    ...
    VirtualDataSource.prototype.getUnrealizedCount = function () {
        var a = this.db.g * this.actualPageSize;
    ...
    VirtualDataSource.prototype.es = function () {
        ...
        if (this.actualDataProvider != null) {
            try {
                for (var _b = tslib_1.__values(fromEnum(this.di.values)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var a = _c.value;
    ...
    VirtualDataSource.prototype.dg = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    VirtualDataSource.prototype.indexOfKey = function (a) {
        ...
        if (this.an && this.shouldEmitSectionHeaders && !this.isSectionContentVisible && this.isSectionHeaderNormalRow) {
            if (this.da.t.count > 0) {
                for (var d = 0; d < this.da.t.count; d++) {
                    var e = this.da.t._inner[d];
    ...
    VirtualDataSource.prototype.c7 = function () {
    ...
    VirtualDataSource.prototype.getStickyRowsInRange = function (a, b) {
        ...
        if (this.da.t.count > 0) {
            ...
            for (var f = this.actualCount - this.d1; f < this.actualCount; f++) {
                e.add(f);
            }
            return e.toArray();
        }
        ...
        for (var r = this.actualCount - this.d1; r < this.actualCount; r++) {
            g.add(r);
        }
        this.cs = g.toArray();
        return this.cs;
    ...
    VirtualDataSource.prototype.ec = function (a) {
        var b = "";
    ...
    VirtualDataSource.prototype.ed = function (a, b) {
        if (this.sectionHeaderDisplayMode == 0) {
            return this.ec(a);
        }
        var c = "";
    ...
    VirtualDataSource.prototype.ck = function (a, b) {
        if (a == 5) {
            var c = b;
            var d_1 = c.a;
