...
var IgcDataSeriesCollection = /** @class */ /*@__PURE__*/ (function (_super) {
    tslib_1.__extends(IgcDataSeriesCollection, _super);
    function IgcDataSeriesCollection(list) {
    ...
    IgcDataSeriesCollection.prototype._createInnerColl = function () {
        if (!DataSeries.$type) {
            DataSeries.$type = markType(DataSeries, "DataSeries");
        }
    ...
    return IgcDataSeriesCollection;
}(IgCollection));
export { IgcDataSeriesCollection };
//# sourceMappingURL=igc-data-series-collection.js.map
