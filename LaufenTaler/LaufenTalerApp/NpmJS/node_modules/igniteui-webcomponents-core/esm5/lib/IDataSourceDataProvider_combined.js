...
var SumSummaryCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SumSummaryCalculator.prototype.get_displayName = function () {
        var a = BaseDataSource.a7("DataSource_Summary_Sum");
        return a != null ? a : "Sum";
    };
...
var CountSummaryCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CountSummaryCalculator.prototype.get_displayName = function () {
        var a = BaseDataSource.a7("DataSource_Summary_Count");
...
var AverageSummaryCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AverageSummaryCalculator.prototype.get_displayName = function () {
        var a = BaseDataSource.a7("DataSource_Summary_Avg");
        return a != null ? a : "Avg";
    };
...
var MaxSummaryCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    MaxSummaryCalculator.prototype.get_displayName = function () {
        var a = BaseDataSource.a7("DataSource_Summary_Max");
        return a != null ? a : "Max";
    };
...
var MinSummaryCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    MinSummaryCalculator.prototype.get_displayName = function () {
        var a = BaseDataSource.a7("DataSource_Summary_Min");
        return a != null ? a : "Min";
    };
...
var BaseDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function BaseDataSource() {
        ...
        _this.r.n(runOn(_this, _this.cp));
        _this.q.n(runOn(_this, _this.bt));
        _this.s.n(runOn(_this, _this.cq));
        _this.h = new FilterExpressionCollection();
        _this.h.m(runOn(_this, _this.br));
        _this.t = new TransactionService(runOn(_this, _this.bv), runOn(_this, _this.clone1), new TransactionKeyEqualityComparer());
        var a = _this.t;
        a.stateChanged = delegateCombine(a.stateChanged, runOn(_this, _this.cl));
        return _this;
    }
    BaseDataSource.prototype.cl = function (a, b) {
        if (a == 0 || a == 1) {
    ...
    BaseDataSource.prototype.cq = function (a, b) {
    ...
    BaseDataSource.prototype.onActualDataProviderChanged = function (a, b) {
        ...
        if (c != null) {
            c.schemaChanged = delegateRemove(c.schemaChanged, runOn(this, this.bn));
        }
        if (d != null) {
            d.schemaChanged = delegateCombine(d.schemaChanged, runOn(this, this.bn));
    ...
    BaseDataSource.prototype.bn = function (a, b) {
        var _this = this;
    ...
    BaseDataSource.prototype.bx = function () {
    ...
    BaseDataSource.prototype.queueAutoRefresh = function () {
        ...
        if (this.executionContext != null) {
            this.u = true;
            this.executionContext.enqueueAction(runOn(this, this.bp));
        }
    };
    BaseDataSource.prototype.bp = function () {
        if (this.deferAutoRefresh) {
            this.u = false;
            return;
        }
    ...
    BaseDataSource.prototype.cn = function () {
        if (this.actualBaseDataProvider != null) {
