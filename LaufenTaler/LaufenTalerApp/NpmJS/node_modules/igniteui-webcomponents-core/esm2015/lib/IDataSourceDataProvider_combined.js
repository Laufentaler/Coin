...
export let SumSummaryCalculator = /*@__PURE__*/ (() => {
    class SumSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a7("DataSource_Summary_Sum");
            return a != null ? a : "Sum";
        }
        get displayName() {
...
export let CountSummaryCalculator = /*@__PURE__*/ (() => {
    class CountSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a7("DataSource_Summary_Count");
...
export let AverageSummaryCalculator = /*@__PURE__*/ (() => {
    class AverageSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a7("DataSource_Summary_Avg");
            return a != null ? a : "Avg";
        }
        get displayName() {
            return this.get_displayName();
...
export let MaxSummaryCalculator = /*@__PURE__*/ (() => {
    class MaxSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a7("DataSource_Summary_Max");
            return a != null ? a : "Max";
        }
        get displayName() {
            return this.get_displayName();
...
export let MinSummaryCalculator = /*@__PURE__*/ (() => {
    class MinSummaryCalculator extends SummaryCalculator {
        ...
        get_displayName() {
            let a = BaseDataSource.a7("DataSource_Summary_Min");
            return a != null ? a : "Min";
        }
        get displayName() {
            return this.get_displayName();
...
export let BaseDataSource = /*@__PURE__*/ (() => {
    class BaseDataSource extends Base {
        constructor() {
            ...
            this.r.n(runOn(this, this.cp));
            this.q.n(runOn(this, this.bt));
            this.s.n(runOn(this, this.cq));
            this.h = new FilterExpressionCollection();
            this.h.m(runOn(this, this.br));
            this.t = new TransactionService(runOn(this, this.bv), runOn(this, this.clone1), new TransactionKeyEqualityComparer());
            let a = this.t;
            a.stateChanged = delegateCombine(a.stateChanged, runOn(this, this.cl));
        }
        cl(a, b) {
            if (a == 0 || a == 1) {
