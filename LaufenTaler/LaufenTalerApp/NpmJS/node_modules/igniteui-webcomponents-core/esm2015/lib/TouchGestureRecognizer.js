 ...
 * @hidden
 */
export let TouchGestureRecognizer = /*@__PURE__*/ (() => {
    class TouchGestureRecognizer extends Base {
        constructor(a) {
            super();
            this.n = 0;
    ...
    TouchGestureRecognizer.$t = /*@__PURE__*/ markType(TouchGestureRecognizer, 'TouchGestureRecognizer');
