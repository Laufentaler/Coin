(function (global, factory) {
    ...
    var MorphSegment = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        MorphSegment.prototype.i = function (a) {
            ...
            if (this.b) {
                ...
                var f = igniteuiWebcomponentsCore.GeometryUtil.l(d, e, this.h, !this.c, this.d);
                var g = igniteuiWebcomponentsCore.GeometryUtil.e(f, d);
                var h = igniteuiWebcomponentsCore.GeometryUtil.e(f, e);
                while (this.c && h < g) {
                    h += Math.PI * 2;
                }
                while (!this.c && h > g) {
        ...
        MorphSegment.prototype.j = function (a, b, c) {
            ...
            igniteuiWebcomponentsCore.InterpolationUtil.b(d.f, a, e, g);
            if (d.e) {
                var i = void 0;
                var j = d.f.count;
                for (var k = 0; k < j; k++) {
                    i = d.f._inner[k];
                    d.g.add({ $type: igniteuiWebcomponentsCore.Point_$type, x: i.x, y: i.y });
                }
                d.a = true;
            }
            if (b.d == c.d) {
    ...
    */
    ...
    var XamBulletGraph = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamBulletGraph.prototype.fp = function (a, b) {
            ...
            if (d.count > 0) {
                var e = igniteuiWebcomponentsCore.PolygonUtil.a(this.be(d._inner[0]), a);
                if (e == true) {
            ...
            if (g.count > 0) {
                var h = igniteuiWebcomponentsCore.PolygonUtil.a(this.be(g._inner[0]), a);
                if (h == true) {
            ...
            for (var i = 0; i < this.bb.count; i++) {
                ...
                if (k.count > 0) {
                    var l = igniteuiWebcomponentsCore.PolygonUtil.a(this.be(k._inner[0]), a);
                    if (l == true) {
    ...
    var XamBulletGraphView = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamBulletGraphView.prototype.a4 = function () {
            this.a0();
            if (this.i != null) {
                this.i.aq(this.ag.rootWrapper, "");
            }
        };
        XamBulletGraphView.prototype.a8 = function () {
            if (this.i != null) {
                this.i.bc(this.ag.rootWrapper, "");
            }
        };
        ...
        XamBulletGraphView.prototype.ce = function (a) {
            var b = igniteuiWebcomponentsCore.CanvasGestureDOMEventProxy.cz(this.ag.rootWrapper);
    ...
    */
    ...
    var XamLinearGauge = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamLinearGauge.prototype.bb = function (a) {
            ...
            return igniteuiWebcomponentsCore.PolygonUtil.a(this.bk, a);
        };
        XamLinearGauge.prototype.needleContainsPoint = function (a, b) {
            if (this.bk == null) {
                return false;
            }
            return b ? this.h4.containsPoint(a) : igniteuiWebcomponentsCore.PolygonUtil.a(this.bk, a);
        };
        ...
        XamLinearGauge.prototype.f0 = function (a, b) {
            var c = this.bk;
            if (c != null && c.count > 0) {
                var d = igniteuiWebcomponentsCore.PolygonUtil.a(c, a);
                if (d == true) {
            ...
            for (var e = 0; e < this.bh.count; e++) {
                ...
                var g = f.getPoints(new igniteuiWebcomponentsCore.GetPointsSettings());
                if (g.count > 0) {
                    var h = igniteuiWebcomponentsCore.PolygonUtil.a(this.bl(g._inner[0]), a);
                    if (h == true) {
    ...
    var XamLinearGaugeView = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamLinearGaugeView.prototype.cg = function (a) {
            var b = igniteuiWebcomponentsCore.CanvasGestureDOMEventProxy.cz(this.ah.rootWrapper);
            return { $type: igniteuiWebcomponentsCore.Point_$type, x: a.x - b.left, y: a.y - b.top };
        };
        ...
        XamLinearGaugeView.prototype.a7 = function () {
            this.a3();
            if (this.i != null) {
                this.i.aq(this.ah.rootWrapper, "");
            }
        };
        XamLinearGaugeView.prototype.bb = function () {
            if (this.i != null) {
                this.i.bc(this.ah.rootWrapper, "");
            }
        };
    ...
    */
    ...
    var RadialGaugeScaler = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        function RadialGaugeScaler(a, b, c, d, e) {
            ...
            _this.c = a;
            _this.b = b;
            var f = igniteuiWebcomponentsCore.MathUtil.k(_this.e);
            var g = igniteuiWebcomponentsCore.MathUtil.k(_this.d);
    ...
    */
    ...
    var BackingFrame = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        BackingFrame.prototype.j = function (a, b, c, d) {
            ...
            var as = igniteuiWebcomponentsCore.GeometryUtil.i(ao, an, { $type: igniteuiWebcomponentsCore.Point_$type, x: c, y: d }, r);
            ...
            var a0 = igniteuiWebcomponentsCore.GeometryUtil.i(aw, av, { $type: igniteuiWebcomponentsCore.Point_$type, x: c, y: d }, r);
            if (igniteuiWebcomponentsCore.isNaN_(as.c.x) || igniteuiWebcomponentsCore.isNaN_(as.c.y) || igniteuiWebcomponentsCore.isNaN_(as.d.x) || igniteuiWebcomponentsCore.isNaN_(as.d.y) || igniteuiWebcomponentsCore.isNaN_(a0.c.x) || igniteuiWebcomponentsCore.isNaN_(a0.c.y) || igniteuiWebcomponentsCore.isNaN_(a0.d.x) || igniteuiWebcomponentsCore.isNaN_(a0.d.y)) {
                ...
                if ((Math.pow(a3_1.x - an.x, 2) + Math.pow(a3_1.y - an.y, 2)) <= (Math.pow(a2_1.x - an.x, 2) + Math.pow(a2_1.y - an.y, 2))) {
                    ...
                    a._segments.add(a5);
                    var a6_1 = igniteuiWebcomponentsCore.GeometryUtil.e({ $type: igniteuiWebcomponentsCore.Point_$type, x: c, y: d }, a2_1);
                    var a7_1 = igniteuiWebcomponentsCore.GeometryUtil.e({ $type: igniteuiWebcomponentsCore.Point_$type, x: c, y: d }, a3_1);
                    while (a7_1 < a6_1) {
                        a7_1 += 2 * Math.PI;
                    }
                    var a8 = ((function () {
    ...
    */
    ...
    var RadialGaugeNeedlePreparer = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        RadialGaugeNeedlePreparer.prototype.f = function (a, b, c, d, e) {
            ...
            var aa = f.c == 2;
            if (h) {
                var ab = igniteuiWebcomponentsCore.GeometryUtil.i({ $type: igniteuiWebcomponentsCore.Point_$type, x: m, y: i }, { $type: igniteuiWebcomponentsCore.Point_$type, x: p, y: k }, { $type: igniteuiWebcomponentsCore.Point_$type, x: 0, y: 0 }, l);
            ...
            if (aa) {
                var af = igniteuiWebcomponentsCore.GeometryUtil.i({ $type: igniteuiWebcomponentsCore.Point_$type, x: m, y: i }, { $type: igniteuiWebcomponentsCore.Point_$type, x: p, y: k }, { $type: igniteuiWebcomponentsCore.Point_$type, x: 0, y: 0 }, t);
            ...
            var aw = z;
            if (ai) {
                var ax = igniteuiWebcomponentsCore.GeometryUtil.i({ $type: igniteuiWebcomponentsCore.Point_$type, x: m, y: i }, { $type: igniteuiWebcomponentsCore.Point_$type, x: p, y: k }, { $type: igniteuiWebcomponentsCore.Point_$type, x: o, y: 0 }, q);
    ...
    */
    ...
    var XamRadialGauge = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamRadialGauge.prototype.b5 = function (a) {
            ...
            var e = d.x;
            var f = d.y;
            var g = igniteuiWebcomponentsCore.GeometryUtil.e({ $type: igniteuiWebcomponentsCore.Point_$type, x: e, y: f }, a);
        ...
        XamRadialGauge.prototype.bc = function (a) {
            ...
            return igniteuiWebcomponentsCore.PolygonUtil.a(this.bj, a);
        };
        XamRadialGauge.prototype.needleContainsPoint = function (a, b) {
            if (this.bj == null) {
                return false;
            }
            return b ? igniteuiWebcomponentsCore.PolygonUtil.a(this.bk, a) : igniteuiWebcomponentsCore.PolygonUtil.a(this.bj, a);
        };
        ...
        XamRadialGauge.prototype.gb = function (a) {
            ...
            if (aa != 0 && !ai && ab) {
                ...
                var be = igniteuiWebcomponentsCore.GeometryUtil.i(bd, { $type: igniteuiWebcomponentsCore.Point_$type, x: ar, y: as }, { $type: igniteuiWebcomponentsCore.Point_$type, x: ae, y: af }, ac * k);
                var bf = au;
                var bg = av;
                if (a8 - a6 != 0) {
                    bg = ae;
                ...
                var bj = igniteuiWebcomponentsCore.GeometryUtil.i(bi, { $type: igniteuiWebcomponentsCore.Point_$type, x: av, y: aw }, { $type: igniteuiWebcomponentsCore.Point_$type, x: ae, y: af }, ac * k);
                if (igniteuiWebcomponentsCore.isNaN_(be.c.x) || igniteuiWebcomponentsCore.isNaN_(be.c.y) || igniteuiWebcomponentsCore.isNaN_(be.d.x) || igniteuiWebcomponentsCore.isNaN_(be.d.y) || igniteuiWebcomponentsCore.isNaN_(bj.c.x) || igniteuiWebcomponentsCore.isNaN_(bj.c.y) || igniteuiWebcomponentsCore.isNaN_(bj.d.x) || igniteuiWebcomponentsCore.isNaN_(bj.d.y)) {
                    ...
                    if ((Math.pow(bl.x - ar, 2) + Math.pow(bl.y - as, 2)) <= (Math.pow(bk.x - ar, 2) + Math.pow(bk.y - as, 2))) {
                        ...
                        var bm = igniteuiWebcomponentsCore.GeometryUtil.e({ $type: igniteuiWebcomponentsCore.Point_$type, x: ae, y: af }, bk);
                        var bn = igniteuiWebcomponentsCore.GeometryUtil.e({ $type: igniteuiWebcomponentsCore.Point_$type, x: ae, y: af }, bl);
                        var bo = q;
                        var bp = r;
                        while (bo > Math.PI * 2) {
                            bo -= Math.PI * 2;
    ...
    var XamRadialGaugeView = /** @class */ /*@__PURE__*/ (function (_super) {
        ...
        XamRadialGaugeView.prototype.aq = function () {
            this.am();
            if (this.g != null) {
                this.g.aq(this.z.rootWrapper, "");
            }
        };
        XamRadialGaugeView.prototype.au = function () {
            if (this.g != null) {
                this.g.bc(this.z.rootWrapper, "");
            }
        };
        ...
        XamRadialGaugeView.prototype.as = function (a) {
            ...
            if (this.g != null) {
                ...
                this.g.al = function (m) { return _this.h.ba && (_this.h.a8 || _this.h.bc(m)); };
            }
            this.a6();
        };
    ...
    */
    ...
    GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE:  you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
    */
    var IgxRadialGaugeComponent_PROVIDERS = [];
    ...
    */
    ...
    exports.IgxRadialGaugeComponent_PROVIDERS = IgxRadialGaugeComponent_PROVIDERS;
...
//# sourceMappingURL=igniteui-webcomponents-gauges.umd.js.map
