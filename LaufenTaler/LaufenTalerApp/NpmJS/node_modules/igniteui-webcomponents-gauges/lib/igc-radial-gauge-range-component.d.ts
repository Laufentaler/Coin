...
export declare class IgcRadialGaugeRangeComponent extends IgcHTMLElement {
    protected _implementation: any;
    readonly i: XamRadialGaugeRange;
    private onImplementationCreated;
    constructor();
    readonly rangeInternal: XamRadialGaugeRange;
    protected createImplementation(): XamRadialGaugeRange;
    private _renderer;
    private _provideRenderer;
    static _createFromInternal(internal: any): IgcRadialGaugeRangeComponent;
    ...
    private static _observedAttributesIgcRadialGaugeRangeComponent;
